 ...
 */
public class FriendsGetQueryWithFieldsOverride extends AbstractQueryBuilder<FriendsGetQueryWithFieldsOverride, GetFieldsResponseOverride> {
    /**
     ...
     */
    public FriendsGetQueryWithFieldsOverride(VkApiClient client, UserActor actor, Fields... fields) {
        super(client, "friends.get", GetFieldsResponseOverride.class);
     ...
     * @param actor actor with access token
     */
    public FriendsGetQueryWithFieldsOverride(VkApiClient client, UserActor actor, List<Fields> fields) {
        super(client, "friends.get", GetFieldsResponseOverride.class);
        accessToken(actor.getAccessToken());
        fields(fields);
    }
     ...
     * @param actor actor with access token
     */
    public FriendsGetQueryWithFieldsOverride(VkApiClient client, ServiceActor actor, Fields... fields) {
        super(client, "friends.get", GetFieldsResponseOverride.class);
        accessToken(actor.getAccessToken());
     ...
     * @param actor actor with access token
     */
    public FriendsGetQueryWithFieldsOverride(VkApiClient client, ServiceActor actor, List<Fields> fields) {
        super(client, "friends.get", GetFieldsResponseOverride.class);
        accessToken(actor.getAccessToken());
        clientSecret(actor.getClientSecret());
        fields(fields);
     ...
     */
    public FriendsGetQueryWithFieldsOverride userId(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public FriendsGetQueryWithFieldsOverride order(FriendsOrder value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public FriendsGetQueryWithFieldsOverride listId(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public FriendsGetQueryWithFieldsOverride count(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public FriendsGetQueryWithFieldsOverride offset(Integer value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public FriendsGetQueryWithFieldsOverride nameCase(FriendsNameCase value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    protected FriendsGetQueryWithFieldsOverride fields(Fields... value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    protected FriendsGetQueryWithFieldsOverride fields(List<Fields> value) {
        return unsafeParam("fields", value);
    }

    @Override
    protected FriendsGetQueryWithFieldsOverride getThis() {
        return this;
    }
